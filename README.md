...
- Fast final grade calculation with no loopholes
- Allows for constant checking to ensure you get all the data you need
- Very simple interface

## How To Play
- type this command: g++ main.cpp -o final-grade-calculator 
- then now you can play by then doing: ./final-grade-calculator 

## How I Created The Game:
- Created in VS Code using C++
- Implemented conditional logic to give you a grade estimation 
- Designed an user friendly interface so anyone can use this
- Created the calculation to calculate the final grade
